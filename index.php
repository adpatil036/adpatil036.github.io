	...
	<div class="container-fluid intro" id="about">
		<div class="row">
			<div class="col-md-8 col-md-offset-2">
				...
				<p class="text-intro">Lorem Ipsum is simply dummy text of the printing and typesetting industry.
					...
					<div class="flexslider">
						<ul class="slides">
							<li>
								...
								<p class="twitter-post">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed
							...
							<li>
								...
								<p class="twitter-post">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed
									ut tellus ac nulla semper rhoncus. </p>
							</li>
							<li>
								<div class="flex-twitter-icon"></div>
								<h2 class="twitter-post-username">
								...
								<p class="twitter-post">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed
									ut tellus ac nulla semper rhoncus. Nullam a odio porttitor.</p>
							</li>
						</ul>
					</div>
				</div>
				...
				<div class="col-md-4 left nopadding">
					<div class="left-box-1">
						<div class="img">
							...
							<div class="overlay">
								<a href="./products.php" class="expand">leather seats</a>
					...
					<div class="left-box-2 box">
						<div class="img">
							...
							<div class="overlay">
								<a href="./products.php" class="expand">custom seats</a>
								<a class="close-overlay hidden">x</a>
							</div>
						</div>
					</div>
					...
					<div class="left-box-btm box">
						<div class="img">
							...
							<div class="overlay">
								<a href="./products.php" class="expand">limited edition</a>
								<a class="close-overlay hidden">x</a>
							</div>
						</div>
					</div>
				...
				<div class="col-md-4 mid nopadding">
					<div class="mid-box-1 box">
						<div class="img">
							...
							<div class="overlay">
								<a href="./products.php" class="expand">shop bags</a>
								<a class="close-overlay hidden">x</a>
							</div>
						</div>
					</div>
					<div class="mid-box-2 box">
						<div class="img">
							...
							<div class="overlay">
								<a href="./products.php" class="expand">shop bikes</a>
								<a class="close-overlay hidden">x</a>
							</div>
						</div>
					</div>
				...
				<div class="col-md-4 right nopadding">
					<div class="right-box-1 box">
						<div class="img">
							...
							<div class="overlay">
								<a href="./products.php" class="expand">shop now</a>
								<a class="close-overlay hidden">x</a>
							</div>
						</div>
					</div>
					<div class="right-box-2 box">
						<div class="img">
							...
							<div class="overlay">
								<a href="./products.php" class="expand">shop seats</a>
								<a class="close-overlay hidden">x</a>
							</div>
						</div>
					</div>
					<div class="right-box-3 box">
						<div class="img">
							...
							<div class="overlay">
								<a href="./products.php" class="expand">shop accessories</a>
								<a class="close-overlay hidden">x</a>
							</div>
						</div>
					</div>
		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-md-4 col-md-offset-4">
					<a href="./products.php" class="shop-btn">Discover The Shop</a>
				</div>
			</div>
		</div>
	</section>
			...
			<div class="row">
				<div class="col-md-6 col-md-offset-3 sign-up">
					...
					while ($line = fgets($fh)) {
					 ...
					 <div class="card">
					   <div class="card-body">
						 <h5 class="card-title"><b>' . trim($ldata[0]) . '</b></h5>
						 <p class="card-text">' . trim($ldata[1]) . '</p> 
						 <p class="card-text">' . trim($ldata[2]) . '</p>
						 <p class="card-text">' . trim($ldata[3]) . '</p>
					   </div>
					 </div>
				   </div>';
						}
